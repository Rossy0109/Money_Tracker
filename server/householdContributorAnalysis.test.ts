      ...
      months: [
        {
          ...
          totalAmount: 200,
          contributors: [
            { contributorUserId: 2, amount: 200 },
            { contributorUserId: 3, amount: 0 },
          ],
        },
        {
          monthKey: "2026-07",
          totalAmount: 500,
          contributors: [
            { contributorUserId: 2, amount: 100 },
            { contributorUserId: 3, amount: 400 },
          ],
        },
        {
          monthKey: "2026-08",
          totalAmount: 300,
          contributors: [
            { contributorUserId: 2, amount: 300 },
            { contributorUserId: 3, amount: 0 },
          ],
        },
      ],
