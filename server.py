...
class Database:
    ...
    def connect(self):
        ...
        # Maintaining self.cursor for backward compatibility,
        # but routes will use local cursors for thread safety.
...
class FlaskAPI:
    ...
    def setup_routes(self):
        ...
        def login():
            ...
            # Use local cursor for thread-safety in Flask routes
