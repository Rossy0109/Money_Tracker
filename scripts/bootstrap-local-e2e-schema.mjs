...
const statements = [
  ...
  `CREATE TABLE finance_accounts (
    ...
    name varchar(120) NOT NULL,
     ...
     openingBalanceVoucherId int NULL,
    ...
    KEY finance_accounts_opening_voucher_idx (openingBalanceVoucherId)
  ) ENGINE=InnoDB`,
  ...
  `CREATE TABLE finance_transactions (
    ...
    userId int NOT NULL,
     ...
     occurredAt timestamp NOT NULL,
     createdAt timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
     UNIQUE KEY finance_transactions_idempotency_unique (userId, projectId, idempotencyKey),
     UNIQUE KEY finance_transactions_voucher_unique (voucherId),
     INDEX finance_transactions_fingerprint_idx (requestFingerprint),
