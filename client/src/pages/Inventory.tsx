...
export default function Inventory() {
  ...
  const handleAdjustSubmit = (e: React.FormEvent) => {
    ...
    adjustStockMutation.mutate({
      ...
      reason:
        adjustReason.trim() ||
        (adjustType === "in"
          ? "স্টক বৃদ্ধি (ক্রয়/ফেরত)"
          : "স্টক হ্রাস (বিক্রয়/নষ্ট)"),
    });
  };
  ...
  const handleExportCsv = () => {
    ...
    const headers = [
      "ID,নাম,SKU,ক্যাটাগরি,একক,বর্তমান স্টক,ক্রয়মূল্য (৳),বিক্রয়মূল্য (৳),মোট স্টক মূল্য (৳)",
    ];
                          ...
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                if (
                                  confirm(
                                    `আপনি কি নিশ্চিতভাবে "${item.name}" মুছে ফেলতে চান?`
                                  )
                                ) {
