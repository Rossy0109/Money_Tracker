...
export default function TaxCalculator() {
  ...
  const result = calculateBangladeshIncomeTax(
    income,
    investments,
    category,
    cityType
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <SelectContent className="rounded-xl">
                      <SelectItem value="general">
                        সাধারণ পুরুষ করদাতা (৳ ৩.৫ লাখ)
                      </SelectItem>
                      <SelectItem value="female_senior">
                        মহিলা / ৬৫+ বয়স্ক নাগরিক (৳ ৪ লাখ)
                      </SelectItem>
                      <SelectItem value="specially_abled">
                        প্রতিবন্ধী ব্যক্তি (৳ ৪.৭৫ লাখ)
                      </SelectItem>
                      <SelectItem value="freedom_fighter">
                        গেজেটভুক্ত বীর মুক্তিযোদ্ধা (৳ ৫ লাখ)
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent className="rounded-xl">
                      <SelectItem value="dhaka_ctg">
                        ঢাকা ও চট্টগ্রাম সিটি কর্পোরেশন (৳ ৫,০০০)
                      </SelectItem>
                      <SelectItem value="other_city">
                        অন্যান্য সিটি কর্পোরেশন (৳ ৪,০০০)
                      </SelectItem>
                      <SelectItem value="non_city">
                        সিটি কর্পোরেশনের বাইরের এলাকা (৳ ৩,০০০)
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
          ...
          <div className="lg:col-span-5 space-y-5">
            <div className="bg-gradient-to-br from-[#113a30] via-[#14473b] to-[#0f342b] text-white p-6 rounded-3xl shadow-xl space-y-5 sticky top-6">
              ...
              <div className="space-y-2 py-3 border-y border-white/15 text-xs">
                <div className="flex justify-between">
                  <span className="text-[#b9d6c5]">
                    মোট বার্ষিক আয় (Gross):
                  </span>
                  <span className="font-semibold text-white">
                    ৳ {result.totalGrossIncome.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#b9d6c5]">
                ...
                <div className="flex justify-between">
                  <span className="text-[#b9d6c5]">
                    মোট করযোগ্য আয় (Taxable):
                  </span>
                  <span className="font-semibold text-white">
                    ৳ {result.totalTaxableIncome.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#b9d6c5]">
                    গ্রস ট্যাক্স লায়াবিলিটি:
                  </span>
                  <span className="font-semibold text-white">
                    ৳ {result.grossTaxLiability.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#b9d6c5]">
              ...
              <div className="space-y-2">
                <span className="text-xs font-bold text-[#b9d6c5] block">
                  স্ল্যাব ভিত্তিক ট্যাক্স হিসাব:
                </span>
