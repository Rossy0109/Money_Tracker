...
function App() {
  ...
  // By wrapping handleTransactionUpdated in useCallback, we ensure that the function
  // isn't recreated on every render. This prevents unnecessary re-renders of the
  // TransactionList and Transaction components.
