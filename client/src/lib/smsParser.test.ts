...
describe("smsParser", () => {
  it("parses bKash received money SMS accurately", () => {
    const sms =
      "You have received Tk 2,500.00 from 01712345678. Fee Tk 0.00. Balance Tk 15,250.00. TrxID 9K8L7M6N at 29/08/2026 14:30";
  ...
  it("parses bKash payment to merchant SMS", () => {
    const sms =
      "Payment Tk 850.00 to Shwapno Superstore successful. Ref: 1. Fee Tk 0.00. Balance Tk 14,400.00. TrxID 8A7B6C5D";
    const result = parseTransactionSMS(sms);
  ...
  it("parses Nagad Cash-In SMS", () => {
    const sms =
      "Cash-In Tk 3,000.00 from 01887654321. TxnID: 71AB23CD. Balance: Tk 17,400.00";
    const result = parseTransactionSMS(sms);
  ...
  it("parses Bank credited SMS", () => {
    const sms =
      "Dear Customer, your A/C 1029384756 has been credited with BDT 50,000.00 on 29-Aug-2026. Ref: SALARY-AUG26";
    const result = parseTransactionSMS(sms);
