...
এই নথি **খালি স্টেজিং** পরিবেশের নকশা। এটি কোনো উৎপাদন কাটওভার, প্রকৃত আর্থিক ডেটা স্থানান্তর, পুরোনো credential পুনঃব্যবহার, অথবা দীর্ঘমেয়াদি বিনা-মূল্যের নিশ্চয়তা নয়। বর্তমান live endpoint ও GitHub Pages redirect অপরিবর্তিত থাকবে, যতক্ষণ না নতুন প্রোভাইডার-নিরপেক্ষ authentication, database, storage এবং scheduler সীমা আলাদাভাবে পরীক্ষা করা হয়।
...
কোনো বাস্তব backup dump, বর্তমান `DATABASE_URL`, বা current user identity TiDB staging-এ যাবে না। ভবিষ্যৎ production migration-এর জন্য encrypted export, checksum, foreign-key integrity validation, restore rehearsal, এবং verified identity mapping-এর আলাদা লিখিত অনুমোদন প্রয়োজন।
...
Google OAuth-এর canonical callback হলো **`/api/auth/google/callback`**। Google Console-এ redirect URI কেবল নির্ধারিত Google-staging Preview origin-এর সঙ্গে এই path জুড়ে নিবন্ধন করতে হবে; Preview URL নিশ্চিত হওয়ার আগে কোনো production alias allowlist করা যাবে না। Google-এর নিয়ম অনুযায়ী redirect URI-টি নিবন্ধিত URI-এর সঙ্গে হুবহু মিলতে হবে। [5]
