                        ...
                        <tbody className="divide-y divide-slate-100">
                            {filteredProfiles.map((profile) => (
                                <tr key={profile.id} className="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`px-2 py-0.5 rounded text-[10px] font-black uppercase ${profile.metadata?.role === 'ADMIN' ? 'bg-red-50 text-red-600' : 'bg-blue-50 text-blue-600'}`}>
                                            {profile.metadata?.role || 'ACCOUNTANT'}
                                        </span>
                                    </td>
