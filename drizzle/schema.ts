...
export const users = mysqlTable("users", {
  ...
  role: mysqlEnum("role", ["user", "admin", "input_only"])
    .default("user")
    .notNull(),
...
export const failedLoginAttempts = mysqlTable(
  ...
  table => [
    uniqueIndex("failed_login_attempts_identifier_ip_unique").on(
      table.identifier,
      table.ipAddress
    ),
...
export const financeProjects = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_projects_user_name_unique").on(
      table.userId,
      table.name
    ),
...
export const financeHouseholds = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_households_owner_name_unique").on(
      table.ownerUserId,
      table.name
    ),
...
export const financeHouseholdMembers = mysqlTable(
  "finance_household_members",
  {
    ...
    householdId: int("householdId")
      .notNull()
      .references(() => financeHouseholds.id, { onDelete: "restrict" }),
    ...
    status: mysqlEnum("status", ["pending", "active", "declined", "revoked"])
      .notNull()
      .default("pending"),
  ...
  table => [
    uniqueIndex("finance_household_member_email_unique").on(
      table.householdId,
      table.inviteeEmail
    ),
    uniqueIndex("finance_household_member_user_unique").on(
      table.householdId,
      table.userId
    ),
    index("finance_household_members_user_status_idx").on(
      table.userId,
      table.status
    ),
    index("finance_household_members_household_status_idx").on(
      table.householdId,
      table.status
    ),
  ]
...
export const financeSharedBudgets = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_shared_budgets_household_label_month_unique").on(
      table.householdId,
      table.label,
      table.monthKey
    ),
    index("finance_shared_budgets_household_month_idx").on(
      table.householdId,
      table.monthKey
    ),
  ]
...
export const financeSharedExpenses = mysqlTable(
  "finance_shared_expenses",
  {
    ...
    budgetId: int("budgetId")
      .notNull()
      .references(() => financeSharedBudgets.id, { onDelete: "restrict" }),
    contributorUserId: int("contributorUserId")
      .notNull()
      .references(() => users.id, { onDelete: "restrict" }),
    amount: decimal("amount", { precision: 18, scale: 2 }).notNull(),
  ...
  table => [
    index("finance_shared_expenses_household_date_idx").on(
      table.householdId,
      table.occurredAt
    ),
    index("finance_shared_expenses_budget_idx").on(table.budgetId),
    index("finance_shared_expenses_contributor_idx").on(
...
export const financeVoucherSettings = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_voucher_settings_user_project_unique").on(
      table.userId,
      table.projectId
    ),
  ]
...
export const financeVouchers = mysqlTable(
  "finance_vouchers",
  {
    ...
    totalDebit: decimal("totalDebit", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
    totalCredit: decimal("totalCredit", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
    status: mysqlEnum("status", [
      ...
      .default("draft")
      .notNull(),
    voucherType: varchar("voucherType", { length: 30 })
      .notNull()
      .default("general"),
    fiscalPeriodId: int("fiscalPeriodId").references(
      () => financeFiscalPeriods.id,
      { onDelete: "set null" }
    ),
  ...
  table => [
    uniqueIndex("finance_vouchers_project_voucher_unique").on(
      table.projectId,
      table.voucherNo
    ),
    index("finance_vouchers_user_project_date_idx").on(
      table.userId,
      table.projectId,
      table.date
    ),
...
export const financeVoucherDebits = mysqlTable(
  "finance_voucher_debits",
  {
    ...
    accountId: int("accountId").references(() => financeAccounts.id, {
      onDelete: "set null",
    }),
    chartOfAccountId: int("chartOfAccountId").references(
  ...
  table => [
    ...
    index("finance_voucher_debits_coa_idx").on(table.chartOfAccountId),
  ]
);
...
export const financeVoucherCredits = mysqlTable(
  ...
  table => [
    ...
    index("finance_voucher_credits_coa_idx").on(table.chartOfAccountId),
  ]
);
...
export const financeLedgerEntries = mysqlTable(
  ...
  table => [
    index("finance_ledger_account_date_idx").on(
      table.accountId,
      table.postedAt
    ),
    index("finance_ledger_coa_date_idx").on(
      table.chartOfAccountId,
      table.postedAt
    ),
    index("finance_ledger_voucher_idx").on(table.voucherId),
    index("finance_ledger_account_voucher_idx").on(
      table.accountId,
      table.voucherId
    ),
  ]
...
export const financeJournalEntries = mysqlTable(
  ...
  table => [
    ...
    uniqueIndex("finance_journal_entries_no_unique").on(
      table.projectId,
      table.journalNo
    ),
    index("finance_journal_entries_project_date_idx").on(
      table.projectId,
      table.date
    ),
...
export const financeJournalLines = mysqlTable(
  "finance_journal_lines",
  {
    ...
    accountId: int("accountId")
      .notNull()
      .references(() => financeChartOfAccounts.id, { onDelete: "restrict" }),
    entryType: mysqlEnum("entryType", ["debit", "credit"]).notNull(),
    amount: decimal("amount", { precision: 18, scale: 2 }).notNull(),
    narration: varchar("narration", { length: 300 }),
    sortOrder: int("sortOrder").notNull().default(0),
...
export const financeVoucherReferences = mysqlTable(
  ...
  table => [index("finance_voucher_references_voucher_idx").on(table.voucherId)]
);
...
export const financeAccountTypes = mysqlTable(
  ...
  table => [uniqueIndex("finance_account_types_code_unique").on(table.code)]
);
...
export const financeChartOfAccounts = mysqlTable(
  "finance_chart_of_accounts",
  {
    ...
    accountTypeId: int("accountTypeId")
      .notNull()
      .references(() => financeAccountTypes.id, { onDelete: "restrict" }),
    ...
    openingBalance: decimal("openingBalance", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
  ...
  table => [
    uniqueIndex("finance_chart_of_accounts_project_code_unique").on(
      table.projectId,
      table.code
    ),
    index("finance_chart_of_accounts_user_project_idx").on(
      table.userId,
      table.projectId
    ),
...
export const financeAccountGroups = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_account_groups_project_code_unique").on(
      table.projectId,
      table.code
    ),
    index("finance_account_groups_user_project_idx").on(
      table.userId,
      table.projectId
    ),
...
export const financeFiscalPeriods = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_fiscal_periods_project_name_unique").on(
      table.projectId,
      table.name
    ),
    index("finance_fiscal_periods_user_project_idx").on(
      table.userId,
      table.projectId
    ),
    index("finance_fiscal_periods_status_idx").on(
      table.projectId,
      table.status
    ),
    index("finance_fiscal_periods_dates_idx").on(
      table.projectId,
      table.startDate,
      table.endDate
    ),
...
export const financePeriodLocks = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_period_locks_project_month_unique").on(
      table.projectId,
      table.monthKey
    ),
    index("finance_period_locks_user_project_idx").on(
      table.userId,
      table.projectId
    ),
  ]
...
export const financeVoucherReversals = mysqlTable(
  "finance_voucher_reversals",
  {
    ...
    projectId: int("projectId")
      .notNull()
      .references(() => financeProjects.id, { onDelete: "restrict" }),
    originalVoucherId: int("originalVoucherId")
      .notNull()
      .references(() => financeVouchers.id, { onDelete: "restrict" }),
    reversalVoucherId: int("reversalVoucherId")
      .notNull()
      .references(() => financeVouchers.id, { onDelete: "restrict" }),
  ...
  table => [
    uniqueIndex("finance_voucher_reversals_original_unique").on(
...
export const financeBankReconciliations = mysqlTable(
  "finance_bank_reconciliations",
  {
    ...
    difference: decimal("difference", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
    status: mysqlEnum("status", ["in_progress", "completed", "unreconciled"])
      .default("in_progress")
      .notNull(),
    reconciledAt: timestamp("reconciledAt"),
    reconciledBy: int("reconciledBy").references(() => users.id, {
      onDelete: "set null",
    }),
  ...
  table => [
    index("finance_bank_reconciliations_project_account_idx").on(
      table.projectId,
      table.accountId
    ),
...
export const financeBankReconciliationItems = mysqlTable(
  "finance_bank_reconciliation_items",
  {
    ...
    reconciliationId: int("reconciliationId")
      .notNull()
      .references(() => financeBankReconciliations.id, { onDelete: "cascade" }),
    ledgerEntryId: int("ledgerEntryId").references(
  ...
  table => [
    index("finance_bank_reconciliation_items_reconciliation_idx").on(
      table.reconciliationId
    ),
    index("finance_bank_reconciliation_items_ledger_idx").on(
      table.ledgerEntryId
    ),
  ]
);
...
export const financeAccounts = mysqlTable(
  "finance_accounts",
  {
    ...
    currentBalance: decimal("currentBalance", { precision: 18, scale: 2 })
      ...
      .default("0.00"),
    /**
     * Posted opening-balance voucher (Dr cash/bank, Cr owner's capital) that mirrors
     * `openingBalance` into the general ledger. NULL means the wallet has no opening
     * balance yet, or its opening balance still needs to be posted to the ledger.
     */
    openingBalanceVoucherId: int("openingBalanceVoucherId").references(
      () => financeVouchers.id,
      { onDelete: "set null" }
    ),
    isActive: boolean("isActive").notNull().default(true),
  ...
  table => [
    uniqueIndex("finance_accounts_user_project_name_unique").on(
      table.userId,
      table.projectId,
      table.name
    ),
    index("finance_accounts_user_project_idx").on(
      table.userId,
      table.projectId
    ),
    index("finance_accounts_active_idx").on(table.isActive),
    index("finance_accounts_opening_voucher_idx").on(
      table.openingBalanceVoucherId
    ),
  ]
);
...
export const financeCategories = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_categories_user_project_name_type_unique").on(
      table.userId,
      table.projectId,
      table.name,
      table.type
    ),
    index("finance_categories_user_project_idx").on(
      table.userId,
      table.projectId
    ),
...
export const financeTransactions = mysqlTable(
  "finance_transactions",
  {
    ...
    note: varchar("note", { length: 500 }),
    voucherId: int("voucherId").references(() => financeVouchers.id, {
      onDelete: "set null",
    }),
    idempotencyKey: varchar("idempotencyKey", { length: 120 }),
    requestFingerprint: varchar("requestFingerprint", { length: 64 }),
    recurringTemplateId: int("recurringTemplateId").references(
      () => financeRecurringTransactions.id,
      { onDelete: "set null" }
    ),
  ...
  table => [
    index("finance_transactions_user_project_date_idx").on(
      table.userId,
      table.projectId,
      table.occurredAt
    ),
    index("finance_transactions_user_project_type_idx").on(
      table.userId,
      table.projectId,
      table.type
    ),
    index("finance_transactions_account_idx").on(table.accountId),
    index("finance_transactions_coa_idx").on(table.chartOfAccountId),
    index("finance_transactions_fingerprint_idx").on(table.requestFingerprint),
    uniqueIndex("finance_transactions_idempotency_unique").on(
      table.userId,
      table.projectId,
      table.idempotencyKey
    ),
    uniqueIndex("finance_transactions_voucher_unique").on(table.voucherId),
    uniqueIndex("finance_transactions_recurring_run_unique").on(
...
export const financeDues = mysqlTable(
  ...
  table => [
    index("finance_dues_user_project_type_idx").on(
      table.userId,
      table.projectId,
      table.type
    ),
    index("finance_dues_user_project_opened_idx").on(
      table.userId,
      table.projectId,
      table.openedAt
    ),
    index("finance_dues_user_project_due_idx").on(
      table.userId,
      table.projectId,
      table.dueAt
    ),
...
export const financeDueSettlements = mysqlTable(
  "finance_due_settlements",
  {
    ...
    dueId: int("dueId")
      .notNull()
      .references(() => financeDues.id, { onDelete: "restrict" }),
    accountId: int("accountId").references(() => financeAccounts.id, {
      onDelete: "set null",
    }),
    amount: decimal("amount", { precision: 18, scale: 2 }).notNull(),
  ...
  table => [
    index("finance_due_settlements_user_project_date_idx").on(
      table.userId,
      table.projectId,
      table.occurredAt
    ),
...
export const financeBudgets = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_budgets_user_project_category_month_unique").on(
      table.userId,
      table.projectId,
      table.categoryId,
      table.monthKey
    ),
    index("finance_budgets_user_project_month_idx").on(
      table.userId,
      table.projectId,
      table.monthKey
    ),
...
export const financeBills = mysqlTable(
  ...
  table => [
    index("finance_bills_user_project_due_idx").on(
      table.userId,
      table.projectId,
      table.dueAt
    ),
    uniqueIndex("finance_bills_schedule_cron_task_unique").on(
...
export const financeRecurringTransactions = mysqlTable(
  ...
  table => [
    index("finance_recurring_user_project_next_idx").on(
      table.userId,
      table.projectId,
      table.isActive,
      table.nextRunAt
    ),
    uniqueIndex("finance_recurring_schedule_cron_task_unique").on(
      table.scheduleCronTaskUid
    ),
  ]
);
...
export const auditLogs = mysqlTable(
  "audit_logs",
  {
    ...
    projectId: int("projectId").references(() => financeProjects.id, {
      onDelete: "set null",
    }),
    action: mysqlEnum("action", [
      "create",
...
export const financePrivateStorageObjects = mysqlTable(
  "finance_private_storage_objects",
  {
    ...
    householdId: int("householdId").references(() => financeHouseholds.id, {
      onDelete: "restrict",
    }),
  ...
  table => [
    ...
    index("finance_private_storage_owner_created_idx").on(
      table.ownerUserId,
      table.createdAt
    ),
    index("finance_private_storage_project_created_idx").on(
      table.projectId,
      table.createdAt
    ),
    index("finance_private_storage_household_created_idx").on(
      table.householdId,
      table.createdAt
    ),
  ]
...
export const financeInvoices = mysqlTable(
  ...
  table => [
    uniqueIndex("finance_invoices_project_number_unique").on(
      table.projectId,
      table.invoiceNumber
    ),
    index("finance_invoices_user_project_idx").on(
      table.userId,
      table.projectId
    ),
...
export const financeInvoiceItems = mysqlTable(
  ...
  table => [index("finance_invoice_items_invoice_idx").on(table.invoiceId)]
);
...
export const financeInventoryItems = mysqlTable(
  "finance_inventory_items",
  {
    ...
    purchasePrice: decimal("purchasePrice", { precision: 18, scale: 2 })
      .default("0.00")
      .notNull(),
    sellingPrice: decimal("sellingPrice", { precision: 18, scale: 2 })
      .default("0.00")
      .notNull(),
    currentStock: decimal("currentStock", { precision: 12, scale: 2 })
      .default("0.00")
      .notNull(),
    lowStockThreshold: decimal("lowStockThreshold", { precision: 12, scale: 2 })
      .default("5.00")
      .notNull(),
    notes: text("notes"),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  ...
  table => [
    index("finance_inventory_user_project_idx").on(
      table.userId,
      table.projectId
    ),
...
export const financeEmployees = mysqlTable(
  "finance_employees",
  {
    ...
    baseSalary: decimal("baseSalary", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
    status: mysqlEnum("status", ["active", "inactive", "terminated"])
      .default("active")
      .notNull(),
    paymentMethod: mysqlEnum("paymentMethod", ["cash", "bank", "mobile"])
      .default("cash")
      .notNull(),
  ...
  table => [
    index("finance_employees_user_project_idx").on(
      table.userId,
      table.projectId
    ),
...
export const financeSalaryPayments = mysqlTable(
  "finance_salary_payments",
  {
    ...
    employeeId: int("employeeId")
      .notNull()
      .references(() => financeEmployees.id, { onDelete: "restrict" }),
    monthKey: varchar("monthKey", { length: 7 }).notNull(), // YYYY-MM
    baseSalary: decimal("baseSalary", { precision: 18, scale: 2 }).notNull(),
    bonusAmount: decimal("bonusAmount", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
    allowanceAmount: decimal("allowanceAmount", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
    advanceDeduction: decimal("advanceDeduction", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
    otherDeduction: decimal("otherDeduction", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
    ...
    status: mysqlEnum("status", ["pending", "paid", "partially_paid"])
      .default("pending")
      .notNull(),
    notes: text("notes"),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
  ...
  table => [
    uniqueIndex("finance_salary_employee_month_unique").on(
      table.projectId,
      table.employeeId,
      table.monthKey
    ),
    index("finance_salary_project_month_idx").on(
      table.projectId,
      table.monthKey
    ),
...
export const financeEmployeeAdvances = mysqlTable(
  "finance_employee_advances",
  {
    ...
    employeeId: int("employeeId")
      ...
      .references(() => financeEmployees.id, { onDelete: "restrict" }),
    amount: decimal("amount", { precision: 18, scale: 2 }).notNull(),
    repaidAmount: decimal("repaidAmount", { precision: 18, scale: 2 })
      .notNull()
      .default("0.00"),
  ...
  table => [
    index("finance_employee_advances_project_employee_idx").on(
      table.projectId,
      table.employeeId
    ),
    index("finance_employee_advances_status_idx").on(
      table.projectId,
      table.status
    ),
  ]
...
export type FinanceHouseholdMember =
  typeof financeHouseholdMembers.$inferSelect;
...
export type FinanceRecurringTransaction =
  typeof financeRecurringTransactions.$inferSelect;
export type AuditLog = typeof auditLogs.$inferSelect;
export type FinancePrivateStorageObject =
  typeof financePrivateStorageObjects.$inferSelect;
...
export type InsertFinanceInventoryItem =
  typeof financeInventoryItems.$inferInsert;
...
export type FinanceEmployeeAdvance =
  typeof financeEmployeeAdvances.$inferSelect;
...
export type FinanceVoucherReference =
  typeof financeVoucherReferences.$inferSelect;
...
export type FinanceVoucherReversal =
  typeof financeVoucherReversals.$inferSelect;
export type FinanceBankReconciliation =
  typeof financeBankReconciliations.$inferSelect;
export type FinanceBankReconciliationItem =
  typeof financeBankReconciliationItems.$inferSelect;
...
export const idempotencyKeys = mysqlTable(
  ...
  table => [
    uniqueIndex("idempotency_keys_user_key_unique").on(
      table.userId,
      table.idempotencyKey
    ),
