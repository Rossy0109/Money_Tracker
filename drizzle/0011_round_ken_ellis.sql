...
--> statement-breakpoint
ALTER TABLE `finance_bank_reconciliation_items` ADD CONSTRAINT `finance_bank_recon_items_recon_fk` FOREIGN KEY (`reconciliationId`) REFERENCES `finance_bank_reconciliations`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `finance_bank_reconciliation_items` ADD CONSTRAINT `finance_bank_recon_items_ledger_fk` FOREIGN KEY (`ledgerEntryId`) REFERENCES `finance_ledger_entries`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `finance_bank_reconciliations` ADD CONSTRAINT `finance_bank_recons_coa_fk` FOREIGN KEY (`accountId`) REFERENCES `finance_chart_of_accounts`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `finance_chart_of_accounts` ADD CONSTRAINT `finance_coa_acctype_fk` FOREIGN KEY (`accountTypeId`) REFERENCES `finance_account_types`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `finance_voucher_reversals` ADD CONSTRAINT `finance_voucher_reversals_original_fk` FOREIGN KEY (`originalVoucherId`) REFERENCES `finance_vouchers`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `finance_voucher_reversals` ADD CONSTRAINT `finance_voucher_reversals_reversal_fk` FOREIGN KEY (`reversalVoucherId`) REFERENCES `finance_vouchers`(`id`) ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
