-- Migration 0014: RBAC Tables + Idempotency Keys
-- Creates permissions, roles, user_roles, role_permissions, idempotency_keys tables
-- SAFE: Uses IF NOT EXISTS to be idempotent and avoid failures on re-run
