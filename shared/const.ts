...
export const ADMIN_SESSION_COOKIE = "admin_elevation_token";
export const ADMIN_SESSION_TTL_MS = 15 * 60 * 1000; // 15 minutes
export const ONE_YEAR_MS = 1000 * 60 * 60 * 24 * 365;
export const AXIOS_TIMEOUT_MS = 30_000;
export const UNAUTHED_ERR_MSG = "Please login (10001)";
export const NOT_ADMIN_ERR_MSG = "You do not have required permission (10002)";
export const ADMIN_ELEVATION_REQUIRED_MSG =
  "Administrator elevation required (10003)";
export const INPUT_ONLY_ERR_MSG =
  "Access denied. Input-only users cannot perform this operation (10004)";
